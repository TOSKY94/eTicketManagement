...
{
    partial class CreateEventCommandValidator: AbstractValidator<CreateEventCommand>
    {
        ...
        {
            return !(await _eventRepository.IsEventNameAndDateUnique(e.EventName, e.Date));
        }
    }
}
